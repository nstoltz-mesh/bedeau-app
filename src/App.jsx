...
export default function App() {
  ...
  if (screen === "home") return (
    <div style={s}>
      <div style={{ padding: "32px 20px 16px", borderBottom: "1px solid #2A1A22" }}>
      ...
      <div style={{ padding: "16px 20px 32px", display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{ fontSize: 11, letterSpacing: 2, color: "#8A7060", textTransform: "uppercase", marginBottom: 4 }}>Choisir un mode</div>
      ...
      <div style={s}>
        ...
        <div style={{ padding: "0 20px" }}>
          ...
          <div onClick={() => setFlashFlipped(f => !f)}
            style={{ background: "#140A10", border: `1px solid ${cfg.color}30`, borderRadius: 16, minHeight: 340, padding: "24px 20px", cursor: "pointer", marginBottom: 16, position: "relative" }}>
            ...
            {!flashFlipped ? (
              <>
                ...
                <div style={{ position: "absolute", bottom: 16, right: 20, fontSize: 12, color: "#4A3A40" }}>Appuyer pour retourner →</div>
              </>
            ) : (
              <>
